  ...
  data: () => ({
    ...
    russian_members: [
      ...
      },
      {
        ...
        institute: 'Институт Солнечно-Земной Физики',
        shortNameInst: 'Инст. Солнечно-Земной Физики',
        description: 'Процессы пересоединения в солнечных вспышках, источники тонкой временной структуры микроволнового излучения в солнечных вспышках, свойства и характеристики источников вспышек в радио- и  жесткого рентгеновского излучениях.'
      },
      {
        id: 4,
